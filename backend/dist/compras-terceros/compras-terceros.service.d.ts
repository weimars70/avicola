...
export declare class ComprasTercerosService {
    ...
    constructor(comprasRepository: Repository<Compra>, detallesRepository: Repository<DetalleCompra>, gastosService: GastosService, categoriasService: CategoriasGastosService);
