...
let VentasTercerosController = class VentasTercerosController {
    ...
    create(createVentaDto, req) {
        var _a, _b, _c, _d, _e;
        const idEmpresa = ((_a = req.user) === null || _a === void 0 ? void 0 : _a.id_empresa) || ((_b = req.user) === null || _b === void 0 ? void 0 : _b.idEmpresa);
        if (!idEmpresa)
            throw new Error('Company ID missing in user context');
        const idUsuario = ((_c = req.query) === null || _c === void 0 ? void 0 : _c.id_usuario_inserta) || ((_d = req.user) === null || _d === void 0 ? void 0 : _d.userId) || ((_e = req.user) === null || _e === void 0 ? void 0 : _e.id_usuario) || '';
