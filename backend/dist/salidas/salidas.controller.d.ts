...
export declare class SalidasController {
    ...
    create(createSalidaDto: CreateSalidaDto, id_empresa: number, id_usuario_inserta: string): Promise<import("./entities/salida.entity").Salida>;
    ...
    update(id: string, updateSalidaDto: UpdateSalidaDto, id_empresa: number, id_usuario_actualiza: string): Promise<import("./entities/salida.entity").Salida>;
